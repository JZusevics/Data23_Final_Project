from FinalProject.app.transform.cleaning_functions.talent_json_cleaning.df_transform import *
from FinalProject.app.transform.cleaning_functions.talent_json_cleaning.id_extract import *
from FinalProject.app.transform.cleaning_functions.talent_json_cleaning.json_cleaning_functions import *
from FinalProject.app.transform.cleaning_functions.talent_json_cleaning.junction_table_creator import *
...
def clean_json(candidate_json):
    ...
    [strength_junc, weakness_junc, tech_skill_junc, candidate_json] = skill_junctions(candidate_json_keys,
                                                                                      candidate_json)
