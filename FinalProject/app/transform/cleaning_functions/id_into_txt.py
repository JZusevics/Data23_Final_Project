...
def candidate_id_into_txt(csv: pd.DataFrame, txt: pd.DataFrame):
    ...
    txt['applicant_day_date'] = txt['applicant_day_date'].astype(str)
    csv['applicant_day_date'] = csv['applicant_day_date'].astype(str)
    ...
    #txt['applicant_day_date'] = txt['applicant_day_date'].astype(datetime.date)
    #csv['applicant_day_date'] = csv['applicant_day_date'].astype(datetime.date)
